...
def score_sampling_poking(filename_queue, score='pos', pad_size=200):
    ...
    data = tf.pad(data,[[pad_size,pad_size],[pad_size,pad_size],[0,0]], constant_values=127)
    ...
    if score == 'neg':
        # If negative scoring, add jettering in it
    ...
    scale = tf.pow(2., tf.random_uniform([1], -0.25, 0.25))[0]
